  ...
  if(!is.na(type)){
    switch(type,
           cell={
             ...
             hist(mat$Records,main="Distribution of Records per cell",col="tomato",xlab="Records")
           },
           species={
             mat=sqldf("select Scientific_name, count(*) as Records from indf group by Scientific_name")
             hist(mat$Records,main="Distribution of Records per Species",col="tomato",xlab="Records")
           },
           efforts={
